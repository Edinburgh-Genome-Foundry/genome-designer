...
Events.prototype.unsubscribe = function(uuid) {
  ...
  var found = _.find(this.hash, function(list) {
  ...
  U.ASSERT(found, "Unsubscribe with invalid uuid");
};
...
// Fired to create nodes when deserializing.
// event, node type name, viewgraph that will be the parent, an object
// to which to add a .node property
Events.CREATE_NODE = 'create-node';
